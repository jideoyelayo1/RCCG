...
def json_to_xml(data):
    root = ET.Element("XMLBIBLE", attrib={
                      "xmlns:xsi": "http://www.w3.org/2001/XMLSchema-instance", "biblename": "ENGLISHAMP"})
...
for book_number in range(1, 67):  # 66 books in the Bible
    try:
        with open(f'AMPC_files/book{str(book_number).zfill(2)}.json', 'r', encoding='utf-8') as json_file:
